...
def play(conn, gameData):
    ...
    # math.dict(a, b) a = [hole[0][0], hole[0][1]], b = [balls[0][0], balls[0][1]]
    # 
    # def cal_dist(x1, y1, x2, y2, a, b):   구멍 (x1, y1) 공 (x2, y2) 방해구 (a, b)
    ...
    # 
    # 세타
    # 왼쪽 위 : 270 + atan((abs(balls[0][1] - (y0-5.73sina)/abs(balls[0][0] - (x0+5.73cosa)))))
    # 왼쪽 아래 : 270 - atan((abs(balls[0][1] - (y0+5.73sina)/abs(balls[0][0] - (x0+5.73cosa)))))
    # 오른쪽 위 : 290 - atan((abs(balls[0][1] - (y0-5.73sina)/abs(balls[0][0] - (x0-5.73cosa)))))
    # 오른쪽 아래 : 270 + atan((abs(balls[0][1] - (y0+5.73sina)/abs(balls[0][0] - (x0-5.73cosa)))))
    #
    # sina, cosa 는 목적구와 구멍과의 삼각형에서 목적구의 각이 a
    #
    # 여기서부터 코드를 작성하세요.
